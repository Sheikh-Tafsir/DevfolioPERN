            ...
            {contactsData.map((curElem)=>{
                ...
                <div className="w-2/3 ml-12 lg:ml-30 2xl:ml-40 pt-10" key={curElem.id}>
                    ...
                    <div className="flex mt-5 w-4/5 lg:w-1/2 2xl:w-2/5 justify-between">
                        <a href={curElem.facebookLink} className=" h-8 w-8 lg:h-9 w-9 2xl:h-11 2xl:w-11 bg-orange-600 rounded-md flex justify-centet items-center"><FaFacebookF className="mx-auto lg:h-4 lg:w-4 2xl:h-5 2xl:w-5"/></a>
                        <a href={curElem.instagramLink} className="lg:h-9 w-9 2xl:h-11 2xl:w-11 bg-orange-600 rounded-md flex justify-centet items-center"><FaGithub className="mx-auto lg:h-4 lg:w-4 2xl:h-5 2xl:w-5"/></a>
                        <a href={curElem.githubLink} className="lg:h-9 w-9 2xl:h-11 2xl:w-11 bg-orange-600 rounded-md flex justify-centet items-center"><FaInstagram className="mx-auto lg:h-4 lg:w-4 2xl:h-5 2xl:w-5"/></a>
                        <a href={curElem.linkedinLink} className="lg:h-9 w-9 2xl:h-11 2xl:w-11 bg-orange-600 rounded-md flex justify-centet items-center"><FaLinkedinIn className="mx-auto lg:h-4 lg:w-4 2xl:h-5 2xl:w-5"/></a>
                    </div>
                </div>
                )
            })}
